...
void save_controls() {
  ...
  fprintf(f, "%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n", c->key_forward, c->key_backward, c->key_left, c->key_right, c->key_jump, c->key_fly, c->key_observe, c->key_observe_inset, c->key_item_next, c->key_item_prev, c->key_zoom, c->key_ortho);
